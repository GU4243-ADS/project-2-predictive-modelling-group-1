...
if(run.cv){
  ...
  save(err_cv, file = "../output/err_cvHOG_GBM.RData")
}
```
...
save(fit_train, file = "../output/HOG_GBM_fit_train.RData")
```
...
if(run.test){
  ...
  load(file = "../output/HOG_GBM_fit_train.RData")
  tm_test <- system.time(pred_test <- test(fit_train, dat_test))
  save(pred_test, file = "../output/HOG_GBM_pred_test.RData")
}
```
